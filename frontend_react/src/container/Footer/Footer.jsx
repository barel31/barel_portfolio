	...
	return (
		<>
			...
			<div className="app__footer-cards">
				<div className="app__footer-card" onClick={() => window.open('mailto:barel123133@gmail.com', '_self')}>
					<img src={images.email} alt="email" />
					<a href="mailto:barel123133@gmail.com" className="p-text">
						barel123133@gmail.com
					</a>
				</div>
				<div className="app__footer-card" onClick={() => window.open('tel: +972 (52) 544-4634', '_self')}>
